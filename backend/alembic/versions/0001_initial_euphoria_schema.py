...
def downgrade() -> None:
    for table, column in [("team_members", "registration_number_normalized"), ("team_members", "euphoria_id_normalized"), ("team_members", "phone_normalized"), ("team_members", "email_normalized"), ("team_members", "name"), ("teams", "member_count"), ("teams", "college_type"), ("teams", "submitted_at")]:
        op.drop_index(f"ix_{table}_{column}", table_name=table)
    for table in ("admins", "team_members", "teams", "clubs", "hackathons"):
        op.drop_table(table)
    for name in ("admin_role", "accommodation_type", "registration_status", "college_type"):
